...
def build_model(bert_layer, max_len=512, seed=0):
    ...
    print("Sequence output length: ", sequence_output)
...
checkpoint_path = "training_relations/cnn_plus_lstm/cp.ckpt"
...
with tf.device('/device:GPU:0'):
    ...
    for seed in seeds:
        ...
        prediction_save_path = f"/home/rsaha/projects/def-afyshe-ab/rsaha/projects/RE_656/Seed Results/prediction_labels/cnn_plus_lstm/seed_{seed}/"
...
with open('results cnn_plus_lstm seed=2 batch_size=16.txt','w') as data: 
